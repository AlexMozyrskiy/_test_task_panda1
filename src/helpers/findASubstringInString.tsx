...
export type findASubstringInStringReturnedObjTStype = { isSearchValueFinded: boolean, startFoundIndexes: Array<number>, endFoundIndexes: Array<number> }        // возвращаемый объект
...
const findASubstringInString: findASubstringInStringTSType = (str, searchValue) => {            // параметры: str - строка где будм искать, searchValue - подстрока которую будем искать
    ...
    splitedStr.forEach((element, i) => {
        ...
        let joinedSlicedArr = slicedArr.join("");                                                           // соединим слайснутый массив в строку для его сравнения со строкой которую ищем
